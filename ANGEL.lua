...
sudo_users = {SUDO, 2044104713  ,1223431389}   
...
usertext = '*\n ⌔︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'SourceAngel')..')'
status  = '\n *⌔︙تم ترقيته مطور*'
...
usertext = '\n *⌔︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceAngel')..')'
status  = '\n*⌔︙تم ترقيته مطور*'
...
if LARVIN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌔︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceAngel')..') \n ⌔︙'..LARVIN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
⌔︙Angel TEAM
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌔︙[Source Files](http://t.me/hueerr55)

⌔︙[Source Channel](https://t.me/hueerr55)

⌔︙[TWS Angel](http://t.me/vBvbot) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
⌔︙[Mtwr alswrus](http://t.me/TTITITl)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
send(msg.chat_id_, msg.id_, '*⌔︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'hueerr55')..') \n*⌔︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌔︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'hueerr55')..') \n*⌔︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
usertext = '\n *⌔︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'hueerr55')..')'
status  = '\n*⌔︙تم كتمه عام من الكروبات*'
texts = usertext..status
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌔︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'hueerr55')..')'
status  = '\n*⌔︙تم كتمه عام من الكروبات*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌔︙اسم المستخدم »* '..userid..''
...
{{text = '彡 ANGEL 𝐓𝐄𝐀𝐌 ➢', url="t.me/TTITITl"}},
...
{{text = '⓽', callback_data="/help9"},{text = '⓵⓪', callback_data="/help10"}},
{{text = 'الاوامر الرئيسيه', callback_data="/help"}},
{{text = '-彡 𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌 ➢', url="t.me/TTITITl"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if DAata == '/help9' then
...
inline = {
{{text = 'sᴏᴜʀᴄʀ angel',url='http://t.me/TTITITl'}},
}
...
send(msg.chat_id_,0," *⌔︙العضو :* {["..data.first_name_.."](T.ME/hueerr55)}\n⌔︙["..LARVINAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
